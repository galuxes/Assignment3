...
public class TestHelpers {
    ...
    public static void AssertVector3sEqual(Vector3 actual, Vector3 expected, Vector3EqualityComparer comparer = null)
    {
        ...
        Assert.That(actual, Is.EqualTo(expected).Using(comparer),
            "End value is ({0:0.00000}, {1:0.00000}, {2:0.00000}) but expected ({3:0.00000}, {4:0.00000}, {5:0.00000}) (are you using FixedUpdate?)",
    ...
    public static void LogSolution(Vector3 position, Vector2 velocity)
    {
        Debug.Log(string.Format(".ExpectedPosition(new Vector3({0:0.00000}f, {1:0.00000}f, {2:0.00000}f))\n.ExpectedVelocity(new Vector2({3:0.00000}f, {4:0.00000}f))",
